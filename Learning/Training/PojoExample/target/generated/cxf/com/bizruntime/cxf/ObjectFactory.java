 ...
 * generated in the com.bizruntime.cxf package. 
...
public class ObjectFactory {
    ...
    private final static QName _AdditionResponse_QNAME = new QName("http://cxf.bizruntime.com/", "additionResponse");
    private final static QName _Addition_QNAME = new QName("http://cxf.bizruntime.com/", "addition");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.bizruntime.cxf
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cxf.bizruntime.com/", name = "additionResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cxf.bizruntime.com/", name = "addition")
