 ...
 * generated in the bizruntime.com.wsdl.customerservice package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetCustomerStatusResponse_QNAME = new QName("http://com.bizruntime/wsdl/CustomerService", "getCustomerStatusResponse");
    private final static QName _UpdateCustomer_QNAME = new QName("http://com.bizruntime/wsdl/CustomerService", "updateCustomer");
    private final static QName _LookupCustomerResponse_QNAME = new QName("http://com.bizruntime/wsdl/CustomerService", "lookupCustomerResponse");
    private final static QName _LookupCustomer_QNAME = new QName("http://com.bizruntime/wsdl/CustomerService", "lookupCustomer");
    private final static QName _GetCustomerStatus_QNAME = new QName("http://com.bizruntime/wsdl/CustomerService", "getCustomerStatus");
    private final static QName _UpdateCustomerResponse_QNAME = new QName("http://com.bizruntime/wsdl/CustomerService", "updateCustomerResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: bizruntime.com.wsdl.customerservice
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://com.bizruntime/wsdl/CustomerService", name = "getCustomerStatusResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://com.bizruntime/wsdl/CustomerService", name = "updateCustomer")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://com.bizruntime/wsdl/CustomerService", name = "lookupCustomerResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://com.bizruntime/wsdl/CustomerService", name = "lookupCustomer")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://com.bizruntime/wsdl/CustomerService", name = "getCustomerStatus")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://com.bizruntime/wsdl/CustomerService", name = "updateCustomerResponse")
